...
// GetKeyword is the resolver for the getKeyword field.
func (r *queryResolver) GetKeyword(ctx context.Context, input model.KeywordInput) (*model.KeywordData, error) {
	return r.HotelsHandler.GetKeyword(ctx, input)
}
